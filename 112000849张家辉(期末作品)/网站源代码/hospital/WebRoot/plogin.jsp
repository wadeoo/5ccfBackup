...
<body style="background-image:url(images/slider-image1.jpg)">
  <!--patient login page--><br><br><br>
    ...
    <div class="ui container login">
        <div class="ui red centered card">
                 ...
                 <form class="ui  form log" method="post" action="/hospital/Plogin">
                         <div class="field">
              ...
              <br>
                        ...
                        <div  class="sixteen wide field">   
                         ...
                         <div class="field">
                          <p class="header">没有账号?
                          <a href="newuser.html" id="field1">创建账号</a></p>
