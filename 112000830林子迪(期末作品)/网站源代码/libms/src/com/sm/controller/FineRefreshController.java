...
public class FineRefreshController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute(Constants.STATUS_HEADER, "刷新");
            request.setAttribute(Constants.STATUS_BODY, "刷新成功");
            ...
            request.setAttribute(Constants.STATUS_BODY, "mysql出错 " + ex.toString());
            rd.forward(request, response);
